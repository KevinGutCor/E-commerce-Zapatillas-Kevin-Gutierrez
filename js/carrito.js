...
function cargarProductosCarrito() {
	if (productosEnLS && productosEnLS.length > 0) {
      ...
      <img src="${producto.imagen}" alt="${
		...
		<div class="carrito-procucto-precio">
			<span>Precio</span>
			<p>$${producto.precio}</p>
		</div>
		<div class="carrito-peoducto-subtotal">
			<span>Subtotal</span>
			<p>$${producto.precio * producto.cantidad}</p>
		</div>
		<div id="${
			producto.id
		}" class="btn-elimiar-producto carrito-producto-btn-vaciar">
			<button class="button">
